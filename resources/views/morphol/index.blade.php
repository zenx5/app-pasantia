    ...
    <div class="row">
        ...
        <div class="col-md-10  " >
            ...
            <div class="panel panel-default" style="margin-top:60px">
                <div class="panel-heading" style= "background-color:SkyBlue;">PROYECTOS MORPHOL</div>
...
<div style="overflow-x:auto;">
 <table id="table" class="table table-bordered table-hover dataTable" role="grid" >
            ...
            <tr>
                <td >proyecto 1 </td>
                <td > 03/12/2018 </td>
                <td > micmac, mactor, smic, morphol </td>
                <td>  <a href="{{ route('morphol.create') }}" class="btn btn-success" >Ver</a></td>
